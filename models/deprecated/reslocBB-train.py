...
class resnetTrainer():
    ...
    def train(self, trainLoader, epoch):
        ...
        for i, (inputData, targetData) in enumerate(trainLoader):
            ...
            loss, reg, heat, (regCenLoss, regResLoss) = self.model.forward(inputData, inputClassVec, targetData)
