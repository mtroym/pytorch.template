...
class reslocNM(nn.Module):
    def __init__(self, block, num_blocks, num_classes=1000, dataset = "imagenetLOC"):
        ...
        self.linear_reg1 = nn.Linear(256, num_classes)
        self.linear_reg2 = nn.Linear(256, num_classes)
        self.linear_reg3 = nn.Linear(256, num_classes)

        #-----------------------------------New Class Part----------------------------------

        self.linear_class = nn.Linear(self.num_types, 256)
