...
class reslocNM(nn.Module):
    def __init__(self, block, num_blocks, num_classes=1000, dataset = "imagenetLOC"):
        ...
        self.in_planes = 64
        self.num_types = 1000
        VGGcfg = [512, 512, 'M', 512, 512, 'M', 1024, 1024, 'M', 1024, 1024, 'ME']
        ...
        self.attentionLinear = nn.Linear(512, 512 * 3)
    ...
    def forward(self, x, classVec, target):
        ...
        inFeat = self.layer4(self.layer3(self.layer2(self.layer1(inFeat)))) # torch.Size([24, 512, 56, 56])
...
def createModel(opt):
    ...
    restoreName = 'imagenet20_reslocNA_mse1_LR0.001/model_best.pth.tar'
    ...
    if (opt.frozen):
        print('[WRANING!]: reslocBEEV is A FROZEN VERSION!')
